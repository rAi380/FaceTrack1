...
MONGO_URI = "mongodb+srv://harsh:Harsh2008@cluster0.x2gakgi.mongodb.net/?retryWrites=true&w=majority"
try:
    client = MongoClient(
        MONGO_URI,
    ...
    print("❌ MongoDB Connection Failed (IGNORED)")
    print("Error:", e)
    client = None
    db = None
